...
while True: 
	    ...
	    json_array = json.dumps(line)
            ...
            r = requests.post('http://192.168.1.102/uri', json={"token": "cdda7ec43ef99fe921981755f5f0d51e144fc6fa","ws":[{"t":(data[0,0]),"wg":(data[0,1]),"ws":(data[0,2]),"wd":(data[0,3])}]})
            r.status_code
            200
